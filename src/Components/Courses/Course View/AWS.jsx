...
const accordionItems = [
  {
    ...
    content: <ul className='courseListitem'>
      ...
      <li>AWS Pricing and Support Plans</li> 
    </ul>
  },
  {
  ...
  },
  {
    ...
    <li>Creating and Managing Buckets</li>
    <li>Object Storage and Management</li>
    <li>S3 Versioning and Lifecycle Policies</li>
    <li>S3 Security and Access Control</li>  
  </ul>
  },
  {
    ...
    <li>Subnets, Route Tables, and Internet Gateways</li>
  ...
  },
  {
    ...
    <li>Setting Up and Managing RDS Instances</li>
  ...
  {
    title: 'AWS Architecture and Best Practices',
    content: <ul className='courseListitem'>
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best AWS Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        <h2>AWS Course Overview</h2>
        <div>
          <p>
          AWS offers various courses tailored to different skill levels. For beginners, the AWS Cloud Practitioner Essentials course provides foundational cloud knowledge. Intermediate courses include Architecting on AWS, Developing on AWS, and SysOps on AWS, focusing on design, development, and operational skills, respectively. For advanced users, the Advanced Architecting on AWS course delves deeper into complex architectural solutions. These courses typically range from a few hours to several days and cover essential AWS services, security, and best practices, helping learners build, manage, and scale applications effectively on the AWS platform.
          </p>
        </div>
        <br></br>
        <h2>Who Can Join</h2>
        <div>
          <ul className="courseul">
            <li>BE / BTech / M Tech / BCA / MCA passed aspirants to make their career as AWS Developer</li>
          <li>A candidate who would like to restart their career after a gap.</li>
          <li>IT consultants who provide advisory services to businesses and need to understand AWS capabilities.</li>
          <li>Software developers looking to integrate AWS services into their applications</li>
