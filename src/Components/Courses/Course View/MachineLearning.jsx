...
const accordionItems = [
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Regularization: Ridge and Lasso Regression</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Text Preprocessing & Sentiment Analysis</li>
        <li>Word Embeddings: Word2Vec, GloVe</li>
        <li>Forecasting Methods</li>
        <li>ARIMA, Prophet Time Series Analysis</li>
      </ul>
    ),
  },
  {
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best Machine Learning Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        <h2>Machine Learning Course Overview</h2>
        <div>
          <p>
            A machine learning course typically covers the basics of machine
            learning, including supervised, unsupervised, and reinforcement
            learning. It starts with data preprocessing and exploratory data
            analysis. In supervised learning, it covers algorithms like linear
            and logistic regression, decision trees, random forests, and support
            vector machines. Unsupervised learning topics include clustering
            techniques like k-means and hierarchical clustering, and
            dimensionality reduction methods like PCA. The course also delves
            into neural networks and deep learning, covering concepts like CNNs
            and RNNs. Practical applications are demonstrated through projects
            using tools like Python, scikit-learn, TensorFlow, and Keras.
          </p>
        </div>
        <br></br>
        <h2>Who Can Join</h2>
        <div>
          <ul className="courseul">
            <li>
              Business owners looking to integrate AI and ML into their products
              or services.
            </li>
            <li>
            ...
            <li>
              Software engineers, data analysts, and IT professionals looking to
              upskill.
            </li>
            <li>
              Individuals interested in applying machine learning in academic or
              industrial research.
            </li>
            <li>
              Anyone with a keen interest in AI and machine learning, and basic
      ...
      <section className="coursecareer">
        ...
        <div className="CareerPath">
          ...
          <ul>
            ...
            <li>Machine Learning Product Manager</li>
          </ul>
        </div>
      </section>
