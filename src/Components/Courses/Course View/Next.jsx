...
const accordionItems = [
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Overview and benefits of using Next.js</li>
                <li>Installing Next.js and setting up the environment</li>
                <li>Understanding the project structure (pages, public, styles folders)</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Creating pages in the pages directory</li>
                <li>Understanding file-based routing in Next.js</li>
                <li>Working with dynamic routes using [param] syntax</li>
                <li>Implementing nested routes for complex structures</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to server-side rendering and its benefits</li>
                <li>Implementing SSR using getServerSideProps</li>
                <li>Fetching data from an API in SSR</li>
                <li>SSR vs. client-side rendering in Next.js</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Understanding static site generation and use cases</li>
                <li>Implementing SSG using getStaticProps</li>
                <li>Pre-rendering pages with dynamic paths using getStaticPaths</li>
                <li>Comparing SSG with SSR and client-side rendering</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to API routes in Next.js</li>
                <li>Creating API endpoints in the pages/api directory</li>
                <li>Handling HTTP methods (GET, POST, PUT, DELETE) in API routes</li>
                <li>Connecting to databases from API routes</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Global styles and CSS modules</li>
                <li>Using Sass with Next.js for enhanced styling</li>
                <li>Styled-components and CSS-in-JS approach</li>
                <li>Implementing responsive design in Next.js applications
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Serving static assets from the public directory</li>
                <li>Optimizing images using Next.js Image component</li>
                <li>Lazy loading images and assets</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Managing local state with React hooks </li>
                <li>Introduction to global state management with Context API</li>
                <li>Using Redux for state management in Next.js</li>
                <li>Server-side state management and data fetching</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Implementing user authentication in Next.js</li>
                <li>Using NextAuth.js for authentication flows</li>
                <li>Handling protected routes and user roles</li>
                <li>Storing and managing JWT tokens in Next.js</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to Next.js middleware and use cases</li>
                <li>Creating custom middleware for request handling</li>
                <li>Setting up a custom server with Express.js or Koa</li>
                <li>Managing redirects and rewrites with custom server</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Building and exporting a Next.js application for production</li>
                <li>Deploying Next.js on Vercel and other platforms</li>
                <li>Configuring environment variables for different stages</li>
            </ul>
        ),
    },

    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to internationalization in Next.js</li>
                <li>Managing translations and locales</li>
                <li>Dynamic routing with locale-based content</li>
                <li>SEO considerations for internationalized websites</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Setting up Jest for unit testing in Next.js</li>
                <li>Writing and running tests for components and pages</li>
                <li>Using React Testing Library for component testing</li>
                <li>Testing API routes and server-side logic</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Incremental Static Regeneration (ISR) in depth</li>
                <li>Using Next.js Head component for dynamic metadata</li>
                <li>Prefetching and caching strategies with Next.js</li>
                <li>Optimizing SEO with structured data and metadata</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Planning and setting up the project structure</li>
                <li>Implementing SSR, SSG, and client-side rendering where appropriate</li>
                <li>Creating and securing API routes for backend functionality</li>
                <li>Testing, deploying, and monitoring the application in production</li>
            </ul>
        ),
    },
];
        ...
        <div className="courseNameMain">
            ...
            >
                <div className="courseName">
                    <h5>
                        Home {">"} Courses {">"} Next JS
                    </h5>
                    <h2>Best Next JS Training in Erode</h2>
                </div>
            ...
            <section className="CourseSyllabus">
                <h2>Next JS Course Overview</h2>
                <div>
                    <p>
                        Next.js is a powerful React framework that simplifies the development of modern web applications. It supports both server-side rendering (SSR) and static site generation (SSG), improving performance and SEO. With Next.js, developers can build fast, dynamic websites that are optimized out of the box. It offers features like automatic code splitting, client-side routing, API routes, and built-in CSS and Sass support. Next.js also provides a seamless development experience with fast refresh and easy deployment options. It’s ideal for building everything from simple static websites to complex, data-driven applications.
                    </p>
                </div>
                <br></br>
                <h2>Who Can Join</h2>
                <div>
                    <ul className="courseul">
                        <li>
                            Those familiar with React looking to enhance their skills with a powerful framework.
                        </li>
                        <li>
                            Developers who want to build both the front-end and back-end of applications using a single framework.
                        </li>
                        <li>React users aiming to leverage server-side rendering (SSR) and static site generation (SSG) for improved performance and SEO.</li>
                        <li>
                            Anyone wanting to create fast, scalable websites and applications with minimal configuration.
                        </li>
                        <li>
                            Those exploring front-end development and looking for an integrated solution.
                        </li>
                    </ul>
                </div>
                <br></br>
                    ...
                    <div className="realtedCourseBanner">
                        <div className="relatedCoursediv">
                            ...
                            <div className="relatedcourseList">
                                ...
                                <span>
                                    <Link to="/courses/mean">MERN Stack</Link>
                                </span>
                                <span>
                                    <Link to="/courses/vue">Vue JS</Link>
                                </span>
                                <span>
                                    <Link to="/courses/web">Web Developement</Link>
                                </span>
                            </div>
                        </div>
                    </div>
