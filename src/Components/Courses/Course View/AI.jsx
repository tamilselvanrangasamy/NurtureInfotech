...
const accordionItems = [
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>History of AI</li>
        <li>Types of AI (Narrow, General, Superintelligent)</li>
  ...
  {
    title: "Programming Fundamentals for AI",
    content: (
      <ul className="courseListitem">
        <li>Python Basics</li>
        <li>Libraries: NumPy, Pandas, Matplotlib</li>
        <li>Data Types, Structures, and Algorithms</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Probability and Statistics: Distributions, Bayes’ Theorem</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Neural Networks: Perceptrons, Activation Functions</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Applications: Game AI, Robotics</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Data Cleaning: Handling Missing Data, Outliers</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Hadoop and Spark for AI</li>
        <li>Managing and Processing Large Datasets</li>
        <li>Integrating AI with Big Data Technologies</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>AI Services: Machine Learning, Vision, NLP APIs</li>
        <li>Deploying AI Models on the Cloud</li>
...

  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>AI Regulations and Policies</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>AI for Diagnostics and Imaging</li>
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best Artificial Intelligence Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        ...
        <div>
          <p>
            Artificial Intelligence (AI) involves creating systems capable of
            ...
            language understanding, and decision-making. AI encompasses various
            subfields such as machine learning, where systems learn from data;
            natural language processing, which enables machines to understand
            human language; and computer vision, allowing machines to interpret
            visual information. Applications of AI span numerous industries,
            including healthcare, finance, transportation, and entertainment,
            driving innovations like personalized medicine, autonomous vehicles,
            and intelligent virtual assistants. As AI continues to advance, it
            promises to transform how we live and work.
          </p>
        </div>
        <br></br>
        <h2>Who Can Join</h2>
        <div>
          <ul className="courseul">
            <li>
              Especially those studying computer science, mathematics, or
              related fields.
            </li>
            <li>
              Engineers, data scientists, software developers, or IT
              professionals looking to upskill.
            </li>
            <li>
              Individuals from non-technical backgrounds who want to transition
              into the tech field.
            </li>
            <li>
              Academics in fields like psychology, neuroscience, or economics
              interested in AI applications.
            </li>
            <li>
              Teachers and professors aiming to incorporate AI into their
              curriculum.
            </li>
          </ul>
        </div>
