...
const accordionItems = [
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Understanding the Hacker Mindset</li>
        <li>Career Opportunities in Ethical Hacking</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Tools for Footprinting (e.g., Nmap, WHOIS)</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Port Scanning and Services Identification</li>
        <li>Understanding and Detecting Live Systems</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Network Shares and Services</li>
        <li>SNMP Enumeration</li>
        <li>LDAP and DNS Enumeration</li>
        <li>Enumeration Tools </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Hiding Files and Covering Tracks</li>
        <li>ystem Hacking Tools </li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Virus, Worm, and Trojan Analysis</li>
        <li>Malware Detection Techniques</li>
        <li>Creating and Deploying Malware</li>
        <li>Anti-Malware Strategies</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Network Sniffing Techniques</li>
        <li>Packet Analysis</li>
        <li>MAC Attacks</li>
        <li>Sniffing Tools</li>
        <li>Countermeasures Against Sniffing</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Psychological Principles of Social Engineering</li>
        <li>Phishing and Spear Phishing Attacks</li>
        <li>Impersonation and Pretexting
        </li>
        <li>Social Engineering Techniques</li>
        <li>Defense Strategies Against Social Engineering</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Understanding DoS and DDoS</li>
        <li>DoS Attack Techniques</li>
        <li>Botnets and Zombies</li>
        <li>Mitigation Strategies for DoS Attacks</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Understanding Session Hijacking</li>
        <li>Techniques for Session Hijacking</li>
        <li>Network-Level Hijacking</li>
        <li>Application-Level Hijacking</li>
        <li>Prevention Methods for Session Hijacking</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Web Server Attack Techniques</li>
        <li>Exploiting Web Server Flaws</li>
        <li>Web Server Security Tools</li>
        <li>Best Practices for Securing Web Servers</li>
      </ul>
    ),
  },
  ...
  {
    title: "Cloud Security and Ethical Hacking",
    content: (
      <ul className="courseListitem">
        <li>Introduction to Cloud Computing</li>
        <li>Cloud Security Risks and Challenges</li>
        <li>Penetration Testing in the Cloud</li>
        <li>Cloud Security Best Practices</li>
        <li>Tools for Cloud Security Testing</li>
      </ul>
    ),
  },
];
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best Ethical hacking Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        ...
        <div>
          <p>
            Ethical hacking involves the authorized practice of bypassing system
            security to identify potential data breaches and threats in a
            network. Also known as penetration testing or white-hat hacking,
            ethical hackers use the same methods as malicious hackers but with
            permission from the system owner to improve security. Their goal is
            to find vulnerabilities and fix them before they can be exploited.
            Ethical hacking covers various areas including network security,
            application security, and social engineering. It is a critical
            practice for organizations to safeguard their systems, data, and
        ...
        <div>
          <ul className="courseul">
            <li>IT professionals interested in cybersecurity</li>
            <li>Network administrators seeking to enhance security skills</li>
            <li>Students and graduates in computer science or IT fields</li>
            <li>
              System administrators wanting to understand security
              vulnerabilities
            </li>
            <li>Individuals preparing for ethical hacking certifications</li>
          </ul>
        </div>
        <br></br>
      </section>
        ...
        <div className="courseAccordion">
          ...
          <div className="realtedCourseBanner">
            <div className="relatedCoursediv">
              ...
              <span>
                  <Link to="/courses/redhat">Redhat</Link>
                </span>
                <span>
