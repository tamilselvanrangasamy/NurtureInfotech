...
const accordionItems = [
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Key Tools and Technologies</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Essential Libraries: NumPy, Pandas</li>
                <li>Data Visualization: Matplotlib, Seaborn</li>
                <li>Jupyter Notebooks and Environments</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Data Sources: APIs, Web Scraping</li>
                <li>Database Interaction: SQL Basics</li>
                <li>Handling Big Data: Introduction to Hadoop and Spark</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Data Transformation: Normalization, Encoding</li>
                <li>Outlier Detection and Treatment</li>
                <li>Data Integration and Aggregation</li>
            </ul>
        ),
    },
    {
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Classification Algorithms: K-Nearest Neighbors, Decision Trees</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Association Rules: Apriori, Eclat</li>
...

    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Sentiment Analysis</li>
                <li>Advanced Models: Word2Vec, BERT</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Time Series Components: Trend, Seasonality, Noise</li>
                <li>Forecasting Methods: ARIMA, Exponential Smoothing</li>
                <li>Seasonality and Trend Decomposition</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Visualizing Complex Data: Heatmaps, Geospatial Data</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Defining a Data Science Problem</li>
                <li>Data Collection and Cleaning</li>
                <li>Model Building and Evaluation</li>
                <li>Presentation and Communication of Findings</li>
            </ul>
        ),
    },
];
        ...
        <div className="courseNameMain">
            ...
            >
                <div className="courseName">
                    <h5>
                        Home {">"} Courses {">"} Data Science
                    </h5>
                    <h2>Best Data Science Training in Erode</h2>
                </div>
            ...
            <section className="CourseSyllabus">
                <h2>Data Science Course Overview</h2>
                <div>
                    <p>
                        Data science involves extracting insights and knowledge from structured and unstructured data using various techniques and tools. It combines elements of statistics, computer science, and domain expertise to analyze data and inform decision-making. Key processes include data collection, cleaning, exploration, and visualization. Data scientists use algorithms and machine learning models to identify patterns, make predictions, and support strategic decisions. Applications span numerous fields, from business and healthcare to finance and engineering, driving innovations and efficiencies. As data continues to grow exponentially, data science plays a crucial role in transforming raw data into actionable insights.
                    </p>
                </div>
                <br></br>
                <h2>Who Can Join</h2>
                <div>
                    <ul className="courseul">
                        <li>
                            Especially those in mathematics, statistics, computer science, or related fields.
                        </li>
                        <li>
                            Data analysts, business analysts, software developers, or IT professionals seeking to enhance their skills.
                        </li>
                        <li> Individuals from non-technical backgrounds aiming to enter the data science field.</li>
                        <li>
                            Academics interested in applying data science methods to their research.
                        </li>
                        <li>
                            Individuals with a passion for data analysis and statistical modeling.
                        </li>
                    </ul>
                </div>
                <br></br>
                    ...
                    <div className="realtedCourseBanner">
                        <div className="relatedCoursediv">
                            ...
                            <div className="relatedcourseList">
                                ...
                                <span>
                                    <Link to="/courses/artificialintelligence">Artificial Intelligence</Link>
                                </span>
                                <span>
                                    <Link to="/courses/dataanalytics">Data Analytics</Link>
                                </span>
                                <span>
                                    <Link to="/courses/sql">SQL</Link>
                                </span>
                            </div>
                        </div>
                    </div>
