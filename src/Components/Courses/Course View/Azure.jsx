...
const accordionItems = [
  ...
  },
  {
    ...
    content: <ul className='courseListitem'>
    <li>Azure Portal and Interface</li>
    <li>Azure Resource Manager (ARM)</li>
    <li>Azure Subscriptions and Accounts</li>
  ...
  },
  {
    ...
    <li>Storage Access and Security</li>
  ...
  },
  {
    ...
    <li>Load Balancing and Application Gateway</li>  
  </ul>
  },
  {
    title: 'Azure Identity and Access Management',
    content: <ul className='courseListitem'>
    <li>Azure Active Directory (AD)</li>
    <li>Users and Groups Management</li>
    <li>Role-Based Access Control (RBAC)</li>
    <li>Multi-Factor Authentication (MFA)</li>
    <li>Identity Protection and Governance</li>  
  </ul>
  },
  {
    ...
    <li>Azure Database for PostgreSQL
    </li>
  ...
  {
    title: 'Azure DevOps and Development',
    content: <ul className='courseListitem'>
  ...
  {
    title: 'Azure Monitoring and Management',
    content: <ul className='courseListitem'>
    <li>Azure Monitor and Insights</li>
  ...
  {
    title: 'Azure AI and Machine Learning',
    content: <ul className='courseListitem'>
    <li>Azure Cognitive Services</li>
    <li>Azure Machine Learning</li>
    <li>Bot Services</li>
    <li>Data Science Virtual Machines</li>
    <li>AI and ML Best Practices</li>
  </ul>
  },
  {
    title: 'Azure Migration and Modernization',
    content: <ul className='courseListitem'>
    <li>Assessment and Planning</li>
    <li>Azure Migrate</li>
    <li>Workload Migration Strategies</li>
    <li>Post-Migration Best Practices</li>
  </ul>
  },
];
function Azure() {
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best Azure Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        <h2>Azure Course Overview</h2>
        <div>
          <p>
          An Azure course typically covers fundamental concepts of Microsoft Azure, including cloud computing basics, core services, and solutions. Key topics include virtual machines, storage, databases, networking, and identity management. The course also explores Azure's management tools, security features, and compliance standards. Hands-on labs and real-world scenarios help learners apply their knowledge. By the end of the course, participants will understand how to design, deploy, and manage Azure solutions, preparing them for Azure certification exams and roles in cloud administration, development, and architecture.
          </p>
        </div>
        <br></br>
        <h2>Who Can Join</h2>
        <div>
          <ul className="courseul">
            <li>BE / BTech / M Tech / BCA / MCA passed aspirants to make their career as Azure Developer</li>
          <li>IT professionals seeking to upskill in cloud technologies</li>
          <li>Developers aiming to build and deploy applications on Azure</li>
          <li>Businesses and technical decision-makers exploring Azure for their organization</li>
          <li>DevOps engineers integrating Azure into CI/CD pipelines</li>
          </ul>
        </div>
        <br></br>
      </section>
