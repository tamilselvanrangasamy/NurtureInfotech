...
const accordionItems = [
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Overview of Material Design Principles
                </li>
                <li>Setting Up a React Project with MUI
                </li>
                <li>Exploring the MUI Documentation
                </li>
                <li>Creating a Basic MUI App
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to MUI Themes
                </li>
                <li>Customizing the Default Theme
                </li>
                <li>Using the ThemeProvider Component
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Grid System in MUI
                </li>
                <li>Creating Responsive Layouts
                </li>
                <li>Using Box for Layout Customization
                </li>
                <li>Managing Spacing and Alignment
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>TextFields and Form Controls
                </li>
                <li>Select, Checkbox, and Radio Buttons
                </li>
                <li>Implementing Validation with MUI
                </li>
                <li>Customizing Input Styles
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>AppBar and Toolbar
                </li>
                <li>Drawer and Navigation Menus
                </li>
                <li>Tabs and Tab Panels
                </li>
                <li>Implementing Breadcrumbs
                </li>
            </ul>
        ),
    },
    {
        title: "MUI Components - Display",
        content: (
            <ul className="courseListitem">
                <li>Typography and Iconography
                </li>
                <li>Cards and Paper Components
                </li>
                <li>Lists and Tables
                </li>
                <li>Handling Media (Images, Videos)
                </li>
            </ul>
        ),
    },
    {
        title: "MUI Components - Feedback",
        content: (
            <ul className="courseListitem">
                <li>Dialogs and Modals
                </li>
                <li>Snackbars and Toast Notifications
                </li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Creating a Custom Theme from Scratch
                </li>
                <li>Dynamic Theming (Light/Dark Modes)
                </li>
                <li>Overriding Default Component Styles
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Building Complex Forms with MUI
                </li>
                <li>Formik Integration for Form Handling
                </li>
                <li>Yup Validation Schema with MUI
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Component Reusability and Modularity
                </li>
                <li>Lazy Loading and Code Splitting with MUI
                </li>
                <li>Accessibility Best Practices with MUI
                </li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Introduction to MUI Transitions
                </li>
                <li>Creating Animations with the Collapse and Grow Components
                </li>
                <li>Using the Fade and Slide Animations
                </li>
                <li>Custom Animations with CSS-in-JS
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Setting Up Testing for MUI Components
                </li>
                <li>Writing Unit Tests with Jest and React Testing Library
                </li>
                <li>Debugging Common Issues in MUI
                </li>
    ...
    {
        title: "Integrating MUI with Other Libraries",
        content: (
            <ul className="courseListitem">
                <li>MUI with Redux for State Management</li>
                <li>Combining MUI with React Router for Navigation
                </li>
                <li>Using MUI with Formik and Yup
                </li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Planning the Project Layout
                </li>
                <li>Implementing Core Features with MUI
                </li>
                <li>Customizing and Theming the Application
                </li>
                <li>Finalizing and Deploying the Project</li>
            </ul>
        ),
    }
];
        ...
        <div className="courseNameMain">
            ...
            >
                <div className="courseName">
                    <h5>
                        Home {">"} Courses {">"} Material UI
                    </h5>
                    <h2>Best Material UI Training in Erode</h2>
                </div>
            ...
            <section className="CourseSyllabus">
                <h2>Material UI Course Overview</h2>
                <div>
                    <p>
                        Material UI (MUI) is a popular React component library that follows Google’s Material Design guidelines. A course on Material UI typically covers key concepts such as theming, styling, and customization of components. Students learn how to use MUI’s pre-built components like buttons, cards, grids, and dialogs to build responsive and modern user interfaces. The course often includes hands-on projects to practice integrating MUI with React applications, focusing on real-world use cases like form validation, navigation, and state management. By the end, learners gain the skills to efficiently create professional and user-friendly web applications using Material UI.
                    </p>
                </div>
                <br></br>
                <h2>Who Can Join</h2>
                <div>
                    <ul className="courseul">
                        <li>
                            Those who have a basic understanding of React and want to enhance their UI/UX design skills.
                        </li>
                        <li>
                            Professionals looking to streamline their workflow by using a powerful component library.
                        </li>
                        <li>Designers who want to implement Material Design principles in their projects.</li>
                        <li>
                            Individuals aiming to build visually appealing and responsive web applications.
                        </li>
                        <li>
                            Developers who want to improve the efficiency and consistency of their React projects.
                        </li>
                    </ul>
                </div>
                <br></br>
                    ...
                    <div className="realtedCourseBanner">
                        <div className="relatedCoursediv">
                            ...
                            <div className="relatedcourseList">
                                ...
                                <span>
                                    <Link to="/courses/next">Next JS</Link>
                                </span>
                                <span>
