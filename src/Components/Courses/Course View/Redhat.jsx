...
const accordionItems = [
  {
    title: "Introduction to Red Hat Enterprise Linux (RHEL)",
    content: (
      <ul className="courseListitem">
        <li>Overview of RHEL</li>
        <li>Installation and Configuration</li>
        <li>Basic Command Line Usage</li>
        <li>File System Structure and Management</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Permission and Ownership</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Using RPM and YUM Package Managers</li>
        <li>Installing and Removing Software</li>
        <li>Updating and Upgrading Packages</li>
        <li>Managing Repositories</li>
        <li>Troubleshooting Package Issues</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Managing System Logs</li>
        <li>Scheduling Tasks with Cron and At</li>
  ...
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Managing Firewalls with firewalld</li>
        <li>Securing Network Services</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Partitioning and Formatting Disks</li>
        <li>Managing LVM (Logical Volume Manager)</li>
        <li>Mounting and Unmounting File Systems</li>
        <li>Disk Quotas</li>
        <li>Network File Systems (NFS and SMB)</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Using SELinux for Access Control</li>
        <li>Secure Shell (SSH) Configuration</li>
        <li>Implementing Security Audits</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        ...
        <li>Managing Ansible Inventory</li>
        <li>Using Ansible Modules</li>
        <li>Automation and Orchestration Best Practices</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Introduction to KVM (Kernel-based Virtual Machine)</li>
        <li>Installing and Configuring KVM</li>
        <li>Managing Virtual Machines</li>
        <li>Network and Storage for Virtual Machines</li>
        <li>Performance Tuning for Virtual Machines</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Overview of Red Hat Satellite</li>
        <li>Installation and Configuration</li>
        <li>Managing Hosts and Content</li>
        <li>Patching and Updating Systems</li>
        <li>Using Satellite for Automation</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Introduction to OpenShift</li>
        <li>Deploying Applications on OpenShift</li>
        <li>Managing Containers and Pods</li>
        <li>Using OpenShift CLI and Web Console</li>
        <li>Scaling and Monitoring Applications</li>
      </ul>
    ),
  },

  {
    title: "Red Hat Identity Management (IdM)",
    content: (
      <ul className="courseListitem">
        <li>Introduction to Identity Management</li>
        <li>Installing and Configuring IdM</li>
        <li>Managing Users and Groups in IdM</li>
        <li>Configuring IdM Policies</li>
        <li>Integrating IdM with Other Services</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="courseListitem">
        <li>Introduction to High Availability</li>
        <li>Configuring Red Hat Cluster Suite</li>
        <li>Managing Cluster Resources</li>
        <li>Implementing Failover Mechanisms</li>
        <li>Troubleshooting Cluster Issues</li>
      </ul>
    ),
  },
  {
    title: "Red Hat Performance Tuning",
    content: (
      <ul className="courseListitem">
        <li>Performance Monitoring Tools</li>
        <li>Identifying and Resolving Bottlenecks</li>
        <li>Tuning the Kernel and Network</li>
        <li>Optimizing Storage Performance</li>
        <li>Best Practices for Performance Tuning</li>
      </ul>
    ),
  },
  {
    title: "Preparing for Red Hat Certification Exams",
    content: (
      <ul className="courseListitem">
        <li>Overview of Red Hat Certification Tracks</li>
    ...
    <div className="courseNameMain">
      ...
      >
        <div className="courseName">
          ...
          <h2>Best Redhat Training in Erode</h2>
        </div>
      ...
      <section className="CourseSyllabus">
        <h2>Redhat Course Overview</h2>
        <div>
          <p>
            Red Hat, Inc. is a leading provider of open-source software
            solutions, renowned for its enterprise-grade products and services.
            The company is best known for Red Hat Enterprise Linux (RHEL), a
            robust, secure, and scalable operating system designed for
            enterprise environments. Red Hat offers a wide range of products
            including cloud computing solutions, middleware, storage, and
            virtualization technologies. Their offerings support various IT
            infrastructures, from on-premises data centers to public and private
            clouds. Red Hat also emphasizes automation and management tools like
            Ansible and OpenShift for container orchestration. Acquired by IBM
            in 2019, Red Hat continues to drive innovation in the open-source
            community, providing extensive support, training, and certification
            programs to help organizations and professionals optimize their use
        ...
        <div>
          <ul className="courseul">
            <li>System administrators seeking to enhance their Linux skills</li>
            <li>
              IT professionals aiming to manage enterprise-grade Linux
              environments
            </li>
            <li>
              DevOps engineers focusing on automation and containerization.
            </li>
            <li>
              ACloud administrators and architects using Red Hat solutions
            </li>
            <li>
              Students and recent graduates in IT or computer science fields
            </li>
          </ul>
        </div>
        <br></br>
          ...
          <div className="realtedCourseBanner">
            <div className="relatedCoursediv">
              ...
              <div className="relatedcourseList">
                <span>
                  <Link to="/courses/ethicalhacking">Ethical Hacking</Link>
                </span>
                <span>
                  <Link to="/courses/linux">Linux</Link>
                </span>
                <span>
                  <Link to="/courses/aws">AWS</Link>
                </span>
                <span>
                  <Link to="/courses/azure">Azure</Link>
                </span>
                <span>
