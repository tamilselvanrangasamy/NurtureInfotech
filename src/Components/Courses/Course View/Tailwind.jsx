...
const accordionItems = [
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Basic Vue instance</li>
            </ul>
        ),
    },
    {
        title: "Vue CLI and Project Structure",
        content: (
            <ul className="courseListitem">
                <li>Using Vue CLI for project setup</li>
                <li>Understanding the project structure</li>
                <li>Creating and running a Vue project</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Data binding and interpolation</li>
                <li>Common directives (v-bind, v-if, v-for, v-show, v-model)</li>
                <li>Handling events with v-on</li>
            </ul>
        ),
    },
    {
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>Defining routes and navigation</li>
    ...
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                ...
                <li>State, getters, mutations, and actions</li>
                <li>Using Vuex in Vue components</li>
            </ul>
        ),
    },
    {
    ...
    {
        title: "Custom Directives and Filters",
        content: (
            <ul className="courseListitem">
                <li>Creating custom directives</li>
                <li>Using and creating filters</li>
                <li>Applying filters in templates</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Adding basic transitions</li>
                <li>Using transition classes</li>
                <li>Transitioning between elements and routes</li>
            </ul>
        ),
    },
    {
        title: "Vue Component Libraries",
        content: (
            <ul className="courseListitem">
                <li>Introduction to popular libraries (Vuetify, BootstrapVue)</li>
                <li>Integrating component libraries into projects</li>
                <li>Customizing library components</li>
            </ul>
        ),
    },

    {
        title: "Unit Testing with Vue",
        content: (
            <ul className="courseListitem">
                <li>Introduction to testing in Vue</li>
                <li>Setting up Jest for testing</li>
                <li>Writing and running unit tests</li>
            </ul>
        ),
    },
    {
        title: "Building and Deploying Vue Apps",
        content: (
            <ul className="courseListitem">
                <li>Optimizing the build process</li>
                <li>Configuring environment variables</li>
                <li>Deploying to web servers and cloud platforms</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Mixins and custom hooks</li>
                <li>Render functions and JSX</li>
                <li>Scoped slots and dynamic components</li>
            </ul>
        ),
    },
    {
        ...
        content: (
            <ul className="courseListitem">
                <li>Planning and setting up a real-world project</li>
                <li>Implementing features and functionalities</li>
                <li>Testing, optimizing, and deploying the project</li>
            </ul>
        ),
    },
];
        ...
        <div className="courseNameMain">
            ...
            >
                <div className="courseName">
                    ...
                    <h2>Best Tailwind CSS Training in Erode</h2>
                </div>
            ...
            <section className="CourseSyllabus">
                <h2>Tailwind CSS Course Overview</h2>
                <div>
                    <p>
                        A Vue.js course provides an in-depth understanding of this progressive JavaScript framework used for building user interfaces. It covers the core concepts of Vue, including its reactive data binding and component-based architecture. Participants learn to create, manage, and reuse components, implement directives, handle events, and manage state with Vuex. The course typically includes practical projects to build single-page applications (SPAs), enhancing both front-end skills and development workflows. Additional topics often include Vue Router for navigation, Vue CLI for project setup, and integrating with other technologies like REST APIs or GraphQL. By the end, students are equipped to develop dynamic and responsive web applications using Vue.js.
                    </p>
                </div>
                <br></br>
                <h2>Who Can Join</h2>
                <div>
                    <ul className="courseul">
                        <li>
                            Those looking to expand their skill set with a modern JavaScript framework.
                        </li>
                        <li>
                            Developers familiar with JavaScript who want to learn a new framework for building user interfaces.
                        </li>
                        <li>Individuals aiming to build dynamic, responsive web applications.</li>
                        <li>
                            Those wanting to gain front-end skills to become full-stack developers.
                        </li>
                        <li>
                            Anyone interested in learning web development for personal projects.
                        </li>
                    </ul>
                </div>
                <br></br>
